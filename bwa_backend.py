...
def router_node(state: State) -> dict:
    decider = fast_llm.with_structured_output(RouterDecision)
...
def orchestrator_node(state: State) -> dict:
    planner = smart_llm.with_structured_output(Plan)
...
def decide_images(state: State) -> dict:
    planner = fast_llm.with_structured_output(GlobalImagePlan)
